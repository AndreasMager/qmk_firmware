...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAG] = LAYOUT_5x6(
        ...
        KC_AGAIN, KC_V  , KC_P  , KC_L  , KC_C  , KC_F  ,                         KC_K  , KC_U  , KC_O  , KC_Y  , KC_J ,KC_FIND,
        KC_UNDO, KC_R  , KC_T  , KC_N  , KC_S  , KC_D  ,                        KC_QUOT, KC_A  , KC_E  , KC_I  , KC_H ,KC_CAPS,
        KC_APP , KC_Z  , KC_B  , KC_M  , KC_G  , KC_W  ,                         KC_X  , KC_DOT,KC_MINS,KC_COMM, KC_Q ,KC_APP,
    ...
    [_RAISE] = LAYOUT_5x6(
        QK_BOOT,_______   ,_______  ,_______  ,KC_CAPS  ,_______,                    KC_QWER,KC_MAG  ,_______,RGB_VAI,RGB_SAI,QK_BOOT,
        _______,C(KC_BSPC),KC_PSTE  ,_______  ,KC_COPY  ,KC_FIND,                  KC_BSLS, DE_UE  , DE_OE ,_______,_______,RGB_TOG,
        _______,KC_LEFT   ,KC_DOWN  ,KC_UP    ,KC_RIGHT ,KC_CUT ,                  _______, DE_AE  ,DE_EURO,KC_EXLM,KC_QUES,RGB_MOD,
        _______,KC_HOME   ,KC_PGDN  ,KC_PGUP  ,KC_BSPC  ,KC_END ,                  KC_DEL ,KC_COLN ,KC_TILD,KC_SCLN,DE_SS  ,RGB_HUI,
                        _______  ,_______,                                                    _______,_______,
    ...
    [_QWERTY] = LAYOUT_5x6(
        ...
        KC_APP , KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,_______,
                       KC_OLCTL,KC_OLALT,                                                      KC_ORALT,KC_ORCTL,
                                       KC_OLSFT,OSL(_LOWER),                   OSL(_LOWER) ,KC_ORSFT,
                                        KC_ESC ,KC_RAISE,                      KC_RAISE    ,KC_SPC,
                                       KC_OLGUI,                                        KC_ORGUI
    ),
